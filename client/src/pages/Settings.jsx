    ...
    <div className="space-y-5 max-w-6xl mx-auto text-gray-900 dark:text-white">
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
        <div>
          ...
          <p className="text-gray-500 dark:text-zinc-400 text-sm">Customize your RelayOps experience</p>
        </div>
      </div>
          ...
          <div className="space-y-4">
            <div className="p-3 rounded hover:bg-gray-50 dark:hover:bg-zinc-700/50 transition">
              ...
              <select
                ...
                className="w-full px-3 py-2 text-sm border border-gray-300 dark:border-zinc-600 rounded-lg bg-white dark:bg-zinc-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none"
              >
